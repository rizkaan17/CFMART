namespace CFMART.Views.Kasir
{
    partial class FormCetakNota
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblKasir = new Label();
            lblTglNota = new Label();
            lblNoNota = new Label();
            lblNamaKasir = new Label();
            label7 = new Label();
            flpItemNota = new FlowLayoutPanel();
            label8 = new Label();
            lblAngkaTotal = new Label();
            lblTotal = new Label();
            lblNamaStatus = new Label();
            lblNamaMetode = new Label();
            label15 = new Label();
            lblMetode = new Label();
            lblGaris2 = new Label();
            lblGaris3 = new Label();
            ...
            lblTanggalNota.TabIndex = 3;
            lblTanggalNota.Text = "Tanggal ";
            // 
            // lblNomorNota
            // 
            ...
            label7.Font = new Font("Dubai Medium", 16F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label7.ForeColor = Color.Black;
            label7.Location = new Point(4, 237);
            label7.Margin = new Padding(4, 0, 4, 0);
            label7.Name = "label7";
            label7.Size = new Size(0, 73);
            label7.TabIndex = 9;
            // 
            // flpItemNota
            // 
            ...
            label8.Font = new Font("Dubai", 8F);
            label8.ForeColor = Color.Black;
            label8.Location = new Point(1, 224);
            ...
            label15.TabIndex = 17;
            label15.Text = "Status Pembayaran";
            // 
            // lblMetode
            // 
            ...
            lblUcapan.TabIndex = 24;
            lblUcapan.Text = "Terima kasih atas kunjungan anda!  ";
            // 
            // btnCetakNota
            // 
            ...
            btnCetakNota.Text = "Cetak";
            btnCetakNota.UseVisualStyleBackColor = false;
            // 
            // btnTutup
            // 
